	...
	<?php if (!empty($this->items)) : ?>
		<div class="sp-simpleportfolio-items sp-simpleportfolio-columns-<?php echo $this->params->get('columns', 3); ?>">
			<?php foreach ($this->items as $this->item) : ?>
				<div class="sp-simpleportfolio-item gallery-page__single" data-groups='[<?php echo $this->item->groups; ?>]'>
					<div class="sp-simpleportfolio-overlay-wrapper gallery-page__single-img clearfix">

						<?php if($this->item->video) : ?>
							<span class="sp-simpleportfolio-icon-video"></span>
						<?php endif; ?>

						<img src="<?php echo $this->item->thumb; ?>" alt="<?php echo $this->item->title; ?>">
							...
							<div class="sp-vertical-middle">
								<div>
									<div class="gallery-page__single-icon">
										<?php if( $this->item->video ) : ?>
											<a class="img-popup" href="#" data-featherlight="#sp-simpleportfolio-video<?php echo $this->item->id; ?>"><span class="icon-plus"></span></a>
										<?php else: ?>
											<a class="img-popup" href="<?php echo $this->item->popup_img_url; ?>" data-featherlight="image"><span class="icon-plus"></span></a>
										<?php endif; ?>
										<a class="img-popup-2" href="<?php echo $this->item->url; ?>"><span class="icon-plus"></span></a>
									</div>
